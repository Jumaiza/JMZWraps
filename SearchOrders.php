...
<body>
    <div class="box">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table><tr><th>Staff First Name</th><th>Staff Last Name</th><th>Client First Name</th><th>Client Last Name</th><th>Client ID</th><th>Appointment ID</th><th>Products and Quantity</th><th>Shipping Address</th><th>Order Number</th></tr>";

            while ($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row['Stylist First Name'] . "</td><td>" . $row['Stylist Last Name'] . "</td><td>" . $row['Client First Name'] . "</td><td>" . $row['Client Last Name'] . "</td><td>" . $row['Client ID'] . "</td><td>" . $row['Appointment ID'] . "</td><td>" . $row['Products and Quantity'] . "</td><td>" . $row['Shipping Address'] . "</td><td>" . $row['Order Number'] . "</td></tr>";
            }
            echo "</table>";
        } else {
